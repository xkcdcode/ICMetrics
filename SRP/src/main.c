...
//#define TEST_HASH	SRP_SHA224
//#define TEST_HASH	SRP_SHA256
//#define TEST_HASH	SRP_SHA384
...
int main( int argc, char * argv[] )
{
    ...
    srp_create_salted_verification_key( alg, ng_type, username, (const unsigned char *)password,
                strlen(password), 
...
cleanup:
    ...
    printf("Time per call: %d micro seconds\n", (int)(duration / NITER));
